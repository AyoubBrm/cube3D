...
/*   Updated: 2023/11/14 22:15:41 by abouram          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_textures(t_texture_data textures)
{
	if (textures.north.img_width == 32 || textures.north.img_width == 64)
	{
		if (textures.north.img_width == textures.south.img_width
			&& textures.south.img_width == textures.west.img_width
			&& textures.west.img_width == textures.east.img_width)
			return (1);
		else
			return (0);
	}
...
void	draw_fov_line(t_data *data)
{
	...
	while (data->i < WIDTH_SCREEN)
	{
		...
		get_offsets(data, &textures, &x_offset);
